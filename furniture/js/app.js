(() => {
    ...
    function initSliders() {
        if (document.querySelector(".swiperSofa")) new core(".swiperSofa", {
            ...
            on: {
                slideChange: function() {
                    ...
                    var counterElement = document.querySelector(".swiper-counter");
                    var currentSlideElement = counterElement.querySelector(".current-slide");
                    var totalSlidesElement = counterElement.querySelector(".total-slides");
                    currentSlideElement.textContent = currentIndex.toString().padStart(2, "0");
                    totalSlidesElement.textContent = totalSlides.toString().padStart(2, "0");
                }
            }
        });
    }
    if (document.querySelector(".swiperAdv")) new core(".swiperAdv", {
        modules: [ Navigation, Autoplay ],
        observer: true,
        observeParents: true,
        slidesPerView: 3,
        ...
        navigation: {
            prevEl: ".swiperAdv-button-prev",
            nextEl: ".swiperAdv-button-next"
        },
        breakpoints: {
            319: {
                slidesPerView: 1,
    ...
    da.init();
    const categoryButtons = document.querySelectorAll(".filter-category__item");
    categoryButtons.forEach((button => {
        button.addEventListener("click", (() => {
            const activeButton = document.querySelector(".filter-category__item.filter-active");
            if (activeButton) activeButton.classList.remove("filter-active");
