!(function (e, t) {
  ...
  document.addEventListener("DOMContentLoaded", function () {
    const mobileMenuToggle = document.querySelector("[data-mobile-menu-toggle]"),
      mobileMenuDialog = document.querySelector(".mobile-menu"),
      mobileMenuBackdrop = document.querySelector(".mobile-menu__backdrop"),
      mobileMenuCloseButton = document.querySelector("[data-mobile-menu-close]");
    function closeMobileMenu() {
      (document.body.style.overflow = ""),
        mobileMenuToggle.setAttribute("aria-expanded", !1),
        mobileMenuDialog.removeAttribute("open");
    }
    mobileMenuToggle.addEventListener("click", function () {
      (document.body.style.overflow = "hidden"),
        mobileMenuDialog.hasAttribute("open")
          ? closeMobileMenu()
          : (mobileMenuToggle.setAttribute("aria-expanded", !0),
            mobileMenuDialog.setAttribute("open", ""));
    }),
      mobileMenuBackdrop.addEventListener("click", closeMobileMenu),
      mobileMenuCloseButton && mobileMenuCloseButton.addEventListener("click", closeMobileMenu);
  }),
  document.addEventListener("DOMContentLoaded", function () {
    MicroModal.init({
...
function openPopperDropdown(popperDropdownButton, popperDropdownContent) {
  ...
  const popperDropdownOffset = popperDropdownButton.getAttribute("data-popper-offset") || "0,0",
    popperDropdown = new Popper.createPopper(popperDropdownButton, popperDropdownContent, {
      placement: popperDropdownButton.getAttribute("data-popper-placement") || "bottom-start",
      modifiers: [
        { name: "offset", options: { offset: popperDropdownOffset.split(",").map(Number) } },
      ],
    });
...
function closePopperDropdown(popperDropdownButton) {
  ...
  (popperDropdownContent.style.display = "none"),
    ...
    popperDropdownButton.popperInstance &&
      (popperDropdownButton.popperInstance.destroy(), (popperDropdownButton.popperInstance = null)),
...
function handlePopperDropdownDocumentClick(event) {
  activePopperDropdown &&
    !activePopperDropdown.nextElementSibling.contains(event.target) &&
...
popperDropdownTriggers.forEach((popperDropdownButton) => {
  popperDropdownButton.addEventListener("click", (event) => {
    ...
    activePopperDropdown &&
      activePopperDropdown !== popperDropdownButton &&
      closePopperDropdown(activePopperDropdown),
      "true" === popperDropdownButton.getAttribute("aria-expanded")
