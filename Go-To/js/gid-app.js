(() => {
    ...
    const openButtons = document.querySelectorAll(".open-form_btn");
    const page = document.querySelector(".page");
    const script_form = document.querySelector(".form");
    function handleOpenButtonClick() {
        page.classList.add("_disp-none");
        script_form.classList.remove("_disp-none");
        script_form.scrollIntoView({
            behavior: "smooth",
            block: "start"
        });
        window.scrollTo({
    ...
    const closeButtons = document.querySelectorAll(".btn__close-form, [data-close]");
    function handleCloseButtonClick() {
        script_form.classList.add("_disp-none");
        page.classList.remove("_disp-none");
    }
    closeButtons.forEach((function(button) {
        button.addEventListener("click", handleCloseButtonClick);
    }));
    const script_link = document.querySelector('a[data-popup="#popup"]');
    const script_button = document.querySelector(".form__button-send");
